            ...
            <Row>
                ...
                <Col md={7} className="d-flex align-items-center justify-content-center flex-direction-column">
                    <Form style={{ width: "80%", maxWidth: 500 }}>
                        ...
                        <div  className=" mb-5 signup-profile-pic_container text_center">
                            <img src={R1} className="signup-profile-pic" />
                            <label htmlFor="image_upload" className="image-upload-lable">
                                <i className="fas fa-plus-circle add-picture-icon"></i>
                            </label>
                            <input type="file" id="image-upload" aria-hidden accept="image/png, image/jpeg" onChange={validateImg} />
